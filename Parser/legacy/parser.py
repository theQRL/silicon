...
#     3> Change Grammar from BNF to EBNF
...
def parse(token_input, start_symbol, parsing_table):
    flag = 0
    token_input = "IDENTIFIER = IDENTIFIER - IDENTIFIER + IDENTIFIER".split(" ")
    token_input += "$"
