...
class siliconListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by siliconParser#binaryOp.
    def enterBinaryOp(self, ctx:siliconParser.BinaryOpContext):
        pass

    # Exit a parse tree produced by siliconParser#binaryOp.
    def exitBinaryOp(self, ctx:siliconParser.BinaryOpContext):
        pass
